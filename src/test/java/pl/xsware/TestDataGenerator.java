...
public class TestDataGenerator {
    ...
    public static void main(String[] args) {
        ...
        List<Transaction> transactions =  List.of(
                // Wrzesień 2025
                new Transaction(0L, 11L, 7L, "Wynagrodzenie", new BigDecimal("4500"), LocalDate.parse("2025-09-01"), "Wypłata", CategoryType.INCOME, Instant.now(), Instant.now()),
                new Transaction(0L, 11L, 4L, "Żywność", new BigDecimal("200"), LocalDate.parse("2025-09-03"), "Zakupy spożywcze", CategoryType.EXPENSE, Instant.now(), Instant.now()),
                ...
                new Transaction(0L, 11L, 5L, "Transport", new BigDecimal("350"), LocalDate.parse("2025-09-10"), "Paliwo", CategoryType.EXPENSE, Instant.now(), Instant.now()),
                new Transaction(0L, 11L, 9L, "Inne przychody", new BigDecimal("500"), LocalDate.parse("2025-09-15"), "Zwrot podatku", CategoryType.INCOME, Instant.now(), Instant.now()),
                new Transaction(0L, 11L, 2L, "Wydatki", new BigDecimal("80"), LocalDate.parse("2025-09-20"), "Kawa na mieście", CategoryType.EXPENSE, Instant.now(), Instant.now()),
